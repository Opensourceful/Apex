...
export class LmStudioHandler extends BaseProvider implements SingleCompletionHandler {
	...
	async completePrompt(prompt: string): Promise<string> {
		try {
			...
			throw new Error(
				"Please check the LM Studio developer logs to debug what went wrong. You may need to load the model with a larger context length to work with Apex's prompts.",
			)
		}
	}
}
