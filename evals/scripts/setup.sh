...
build_extension() {
  echo "🔨 Building the Apex extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Apex evals database... "
...
read -p "💻 Do you want to build a new version of the Apex extension? [currently $current_version] (y/N): " build_extension
